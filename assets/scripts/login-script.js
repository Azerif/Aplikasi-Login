...
loginFormElement.addEventListener('submit', function(event) {
  ...
  /** 
  * Membuat variabel email untuk menyimpan nilai email yang didapatkan ketika button ditekan.
  * @constant {string}
  */
  const email = inputEmailElement.value;
 
  /** 
  * Membuat variabel password untuk menyimpan nilai password yang didapatkan ketika button ditekan.
  * @constant {string}
  */
